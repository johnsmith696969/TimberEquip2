...
You can execute the `FindListingByFirestoreId` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `FindListingByFirestoreIdData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
You can execute the `GetListingGovernance` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetListingGovernanceData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## ListLifecycleQueue
You can execute the `ListLifecycleQueue` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ListLifecycleQueueData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
You can execute the `ListListingTransitions` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ListListingTransitionsData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
You can execute the `ListOpenListingAnomalies` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ListOpenListingAnomaliesData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## InsertListingShadow
You can execute the `InsertListingShadow` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `InsertListingShadowData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## UpdateListingShadow
You can execute the `UpdateListingShadow` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `UpdateListingShadowData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## DeleteListingShadow
You can execute the `DeleteListingShadow` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `DeleteListingShadowData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
You can execute the `RecordListingStateTransition` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `RecordListingStateTransitionData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## SubmitListing
You can execute the `SubmitListing` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `SubmitListingData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## ApproveListing
You can execute the `ApproveListing` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ApproveListingData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## RejectListing
You can execute the `RejectListing` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `RejectListingData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
You can execute the `ConfirmListingPayment` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ConfirmListingPaymentData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## PublishListing
You can execute the `PublishListing` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `PublishListingData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## ExpireListing
You can execute the `ExpireListing` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ExpireListingData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## RelistListing
You can execute the `RelistListing` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `RelistListingData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## MarkListingSold
You can execute the `MarkListingSold` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `MarkListingSoldData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## ArchiveListing
You can execute the `ArchiveListing` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ArchiveListingData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
You can execute the `ResolveListingAnomaly` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ResolveListingAnomalyData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
