...
export function AdPrograms() {
  ...
  const sellerTiers: SellerTier[] = [
    ...
    },
    {
      ...
      roleLabel: 'dealer',
      icon: Building2,
      summary: 'For active dealerships managing inventory, leads, and branded growth campaigns with a 6-month free launch period.',
      features: [
    ...
    },
    {
      ...
      icon: Crown,
      summary: 'For high-volume dealer groups that need unlimited active inventory, expanded scale, and a 3-month free launch period.',
      features: [
