      ...
      <section className="mx-auto flex min-h-[70vh] w-full max-w-[1600px] items-center px-4 py-16 md:px-8">
        <div className="grid w-full gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(320px,420px)] lg:items-center">
          <div className="space-y-8">
            <div className="inline-flex items-center gap-3 rounded-full border border-border bg-card/80 px-4 py-2 text-[11px] font-black uppercase tracking-[0.28em] text-muted shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <h1 className="max-w-4xl text-5xl font-black uppercase tracking-[-0.04em] text-foreground sm:text-6xl">
                Page Not Found
              </h1>
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                to="/"
                className="inline-flex items-center gap-2 rounded-md bg-primary px-5 py-3 text-sm font-black uppercase tracking-[0.18em] text-primary-foreground transition hover:opacity-90"
              >
              ...
              <Link
                to="/search"
                className="inline-flex items-center gap-2 rounded-md border border-border bg-card px-5 py-3 text-sm font-black uppercase tracking-[0.18em] text-foreground transition hover:border-primary hover:text-primary"
              >
          ...
          <div className="rounded-[28px] border border-border bg-card p-8 shadow-[0_24px_80px_rgba(0,0,0,0.18)]">
            ...
            <div className="mt-6 space-y-4">
              <Link
                ...
                className="block rounded-2xl border border-border bg-background px-5 py-4 transition hover:border-primary"
              >
